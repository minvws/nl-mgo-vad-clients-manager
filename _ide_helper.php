...
namespace RabbitEvents\Listener\Facades {
     ...
     */        class RabbitEvents {
        ...
        {
                        /** @var \RabbitEvents\Listener\Dispatcher $instance */
         ...
         *
         * @param callable $resolver
         * @return \RabbitEvents\Listener\Dispatcher 
         * @static 
         */        public static function setQueueResolver($resolver)
        {            //Method inherited from \Illuminate\Events\Dispatcher         
                        /** @var \RabbitEvents\Listener\Dispatcher $instance */
         ...
         */        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Events\Dispatcher         
                        \RabbitEvents\Listener\Dispatcher::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
         ...
         */        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Events\Dispatcher         
                        \RabbitEvents\Listener\Dispatcher::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
         ...
         */        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Events\Dispatcher         
                        return \RabbitEvents\Listener\Dispatcher::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
         ...
         */        public static function flushMacros()
        {            //Method inherited from \Illuminate\Events\Dispatcher         
                        \RabbitEvents\Listener\Dispatcher::flushMacros();
        }
            }
    }
...
namespace Illuminate\Support {
     ...
     */        class Str {
         ...
         * 
         *
         * @see \App\Support\Str\Initials::__invoke()
         * @param string $input
         * @return string 
         * @static 
         */        public static function initials($input)
        {
                        return \Illuminate\Support\Str::initials($input);
        }
            }
            /**
     * 
     ...
     */        class Stringable {
         ...
         */        public static function initials($input)
        {
                        return \Illuminate\Support\Stringable::initials($input);
        }
            }
    }
...
namespace  {
            ...
            class RabbitEvents extends \RabbitEvents\Listener\Facades\RabbitEvents {}
    }
